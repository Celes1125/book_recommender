...
app = Flask(__name__)
CORS(app, origins=["https://book-recommender-l9xn.vercel.app", "http://localhost:4200", "https://book-recommender-p04kx8182-celes-projects-b4460b91.vercel.app/"], supports_credentials=True)
load_dotenv()
